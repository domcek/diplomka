...
def main(spin,theta,height,phoindex,n,out,step1,start,finish,err_fit):
	...
	m.setPars({1:spin,2:theta,3:np.exp(start),5:np.exp(finish),7:height,8:phoindex,18:1.5e-5})
	...
	yscale('log')
	ylim([10**(-22),10**4])
	#errorbar(rx ,ry, yerr = err_r, marker = "None", linestyle = "None") #weird stuff
	...
	f = open("./play/values_now25.txt",'w')
